...
library(xtable)
filelist=c("alignment/sample1_7day.bam","alignment/sample1_21day.bam");
labellist=c("sample1_7day","sample1_21day");
reads=c(1463,1453);
mappedreads=c(1463,1453);
totalsgrnas=c(56869,56869);
zerocounts=c(56144,56132);
giniindex=c(0.9876744095562832,0.9877762655053031);
...
genboxplot("geckov2_sgrnas.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.5,height=4.5>>=
genhistplot("geckov2_sgrnas.count_normalized.txt");
@
...
genpcaplot("geckov2_sgrnas.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.5,height=4.5>>=
genclustering("geckov2_sgrnas.count_normalized.txt");
@
